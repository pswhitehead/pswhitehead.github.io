import { MinimalStim } from './core-3.2.js';
import { WindowMixin } from './core-3.2.js';
import { mix, toNumerical, to_px, getPositionFromObject, toString, IsPointInsidePolygon, to_unit, to_pixiPoint } from './util-3.2.js';
import { Color } from './util-3.2.js';
import { ColorMixin } from './util-3.2.js';
import { PsychoJS } from './core-3.2.js';
import { Clock } from './util-3.2.js';
...
class ImageStim extends mix(VisualStim).with(ColorMixin)
{
	...
	contains(object, units) {
		...
		const displaySize = this._getDisplaySize();
                let size_px = to_px(displaySize, this.units, this._win);
		const polygon_px = [
