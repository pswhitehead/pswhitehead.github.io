...
export { Clock, Color, ColorMixin, CountdownTimer, EventEmitter, IsPointInsidePolygon, Logger, MonotonicClock, PsychObject, Scheduler, addInfoFromUrl, detectBrowser, flattenArray, getErrorStack, getPositionFromObject, getUrlParameters, isEmpty, isInt, makeUuid, mix, offerDataForDownload, promiseToTupple, selectFromArray, shuffle, sliceArray, toNumerical, toString, to_height, to_norm, to_pixiPoint, to_px, to_unit, to_win };
